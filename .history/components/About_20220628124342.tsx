  ...
  return (
    <section className='bg-teal-50 flex justify-between items-center  p-24 mx-auto '>
        ...
        <div className='space-x-6 flex justify-center mt-6'>
            <Link href=""><a> <Image className="rounded-full transform hover:scale-120 transition ease-out duration-400" src={linkedin} width={40} height={40} alt="Linkedin"/></a></Link>
