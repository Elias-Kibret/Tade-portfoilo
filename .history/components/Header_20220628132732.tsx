            ...
            <li>
                <Link href="/" className="relative">
                    ...
                    <a className="hover-state"> Publications <span></span></a>
                        <div className="absolute top-24 -mx-10 -mt-3 w-96 h-32 bg-black">
                            <div className="text-gray-200 flex c">
                               <Link href=""><a>JOURNAL PAPERS</a></Link>
                               <Link href=""><a>CONFERNACE PAPERS</a></Link>
                               <Link href=""><a>ACADEMIC THESES</a></Link> 
                            </div>
