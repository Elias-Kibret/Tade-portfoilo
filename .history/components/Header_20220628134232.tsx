    ...
    <span>Tadesse G. Wakjira</span>
      ...
      <div className="flex justify-between">
        <nav className="flex list-none space-x-10  hidden md:inline-flex text-black-200">
            <li className="">
                <Link href="/">
                    <a className="hover-state flex space-x-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 space-x-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
