  ...
  return (
    <section className='bg-teal-50 flex justify-between items-center  p-24 mx-auto '>
        ...
        <div className='space-x-6 flex justify-center mt-6'>
            <Link href=""><a> <Image className="rounded-full" src={linkedin} width={40} height={40} alt="Linkedin"/></a></Link>
            <Link href=""><a><Image className='rounded-full' src={googleSchoolar} width={40} height={40} alt="Linkedin"/></a></Link>
            <Link href=""><a><Image className='rounded-full' src={researchGate} width={40} height={40} alt="Linkedin"/></a></Link>
            <Link href=""><a><Image className='rounded-full' src={orcid} width={40} height={40} alt="Linkedin"/></a></Link>
        </div>
        </div>
        <div className='w-4/5'>
           <p>
