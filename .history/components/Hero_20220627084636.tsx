...
<div className='w-4/5 mx-auto flex justify-between items-center text-left'>
<div className='w-1/2 rounded-lg border border-gray-50 px-10 py-8 text-left' >
      <h1 className="text-4xl font-bold text py-4 px-6 ">
        I'm Tadessa G.Wakjira
      </h1>
 <div>
 <h2 className='text-xl'>Civil Engineer</h2>
 <ul >
