...
const About = () => {
  return (
    <section className='bg-teal-50 flex justify-between items-center  p-24 mx-auto '>
        <div className='w-3/4'>
        <Image  src={profileImage} className="rounded-full object-contain" width={550} height={500} alt="Tadessa G.wakjira"/>
        {/* Social media Links */}
        <div className='space-x-4 flex justify-center'>
            <Link href=""><a> <Image src={linkedin} width={40} height={40} alt="Linkedin"/></a></Link>
            <Link href=""><a><Image src={googleSchoolar} width={40} height={40} alt="Linkedin"/></a></Link>
            <Link href=""><a><Image src={researchGate} width={40} height={40} alt="Linkedin"/></a></Link>
            <Link href=""><a><Image src={orcid} width={40} height={40} alt="Linkedin"/></a></Link>
        </div>
        </div>
        <div className='w-4/5'>
           <p>
